...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{asset('assetsadmin/plugins/overlayScrollbars/css/OverlayScrollbars.min.css')}}"
    />
    <!-- Theme style -->
    <link rel="stylesheet" href="{{asset('assetsadmin/css/adminlte.min.css')}}" />
  ...
  >
        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item has-treeview menu-open">
                <a href="qoutes.php" class="nav-link">
    ...
    <!-- AdminLTE App -->
    <script src="{{asset('assetsadmin/js/adminlte.js')}}"></script>
    ...
    <!-- PAGE SCRIPTS -->
    <script src="{{asset('assetsadmin/js/pages/dashboard2.js')}}"></script>
  </body>
</html>
